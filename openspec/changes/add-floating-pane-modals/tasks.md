...
- [ ] 2.1 Introduce reusable shell overlay hosting so the workspace window can manage both command palette and floating pane modal containers.
...
- [ ] 2.3 Add focused shell tests or regressions for modal focus restore and terminal input isolation, including Escape and text-entry behavior.
...
- [ ] 4.1 Extend pane-tab drag interactions with tear-out to floating modal and dock-back-into-stack flows using explicit drop-priority rules.
- [ ] 4.2 Add regression coverage for pane identity continuity during dock/undock and for extension-pane/plugin ownership validation after presentation moves.
