...
The system SHALL allow each workspace row to show child terminal metadata rows for the terminals contained in that workspace, using subtle presentation that keeps the workspace row visually primary.
